...
public class RedisClientTemplate{
    ...
    public Logger log = LoggerFactory.getLogger(RedisClientTemplate.class);

	private static final String CACHE_CFG_FILE = "redis.properties";
	...
	public RedisClientTemplate(JedisPool jedisPool)
	{
	       this.setJedisPool(jedisPool);	
	       log.info("实例化jedisPool成功");
	}
	...
	private void loadConfig() {
		...
		try {
			inputStream = RedisClientTemplate.class.getClassLoader().getResourceAsStream(CACHE_CFG_FILE);
			properties = new Properties();
			properties.load(inputStream);
		} catch (Exception ex) {
			log.error("加载缓存配置文件失败", ex);
	...
	private void initJedisPool() {
	    ...
	    this.setJedisPool(new JedisPool(config, properties.getProperty("redis.ip"),  
